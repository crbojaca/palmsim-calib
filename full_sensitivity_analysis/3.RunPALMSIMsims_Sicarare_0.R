...
for(subconjunto in 1:20){
  script <- paste0(
    ...
    "                   clima_path = here('full_sensitivity_analysis/ClimateData_Palmas Sicarare_SICARARE_ESPERANZA 11_2008-08-23_2019-01-08_RadiacionNASA.csv'),\n",
    "                   save_path = 'D:/2024_Calibracion_PALMSIM/AnalisisSensibilidadCompleto/Simulaciones_ZN_Sicarare/Results_')\n",
    "}\n"
  )
  
  # Guardar el contenido en un archivo .R
  file_name <- paste0("full_sensitivity_analysis/RunPALMSIMsims_Sicarare/simulacion_subconjunto_", subconjunto, ".R")
